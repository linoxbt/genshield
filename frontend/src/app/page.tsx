    ...
    <div className="space-y-10">
      <section className="max-w-3xl">
        <h1 className="text-3xl font-semibold tracking-tight text-slate-100">
          The policy wording <span className="text-signal-cool">is</span> the settlement logic.
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-slate-400">
          Cover for DeFi protocols, written in plain language and settled without an
          adjudicator. When a claim is filed, the contract gathers its own evidence —
          receipts pulled straight from the insured chain, incident reporting from hosts the
          underwriter nominated — and reads it against the wording under GenLayer consensus.
          No parametric trigger to encode, no oracle adapter, and no resolver key: anyone can
          push a claim to its next stage, and the answer is whatever independent validators
          agree the wording and the evidence say.
        </p>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-sm uppercase tracking-wider text-slate-500">Coverage products</h2>
